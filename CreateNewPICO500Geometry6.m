...
geospecs.outervessel_cylrad  = 23; %460mm/2=23 cm
geospecs.outervessel_cylthick = 0.7;
geospecs.outervessel_knucklerad = 11;
geospecs.outervessel_sphererad = 46;
%geospecs.outervessel_cyllength =%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
geospecs.outervessel_cyllength = 180.7;
...
geospecs.innervessel_cylrad  = 21.4;
geospecs.innervessel_cylthick = 0.7;
geospecs.innervessel_knucklerad = 10;
geospecs.innervessel_sphererad = 42.8;
...
geospecs.vp_upperheight=  85*2.54;
geospecs.vp_lowerheight=  30*2.54;
...
geospecs.camupper_pitch = deg2rad(-inclinacion_cam); %geospecs.vp_upperangle;
geospecs.camupper_yaw = deg2rad(0);
geospecs.camupper_roll = deg2rad(0);
geospecs.camlower_pitch = deg2rad(inclinacion_cam); %geospecs.vp_lowerangle;
...
surface_list(end).inbounds_function = @(p)(reshape( p(:,3,:) > 43 & p(:,3,:)<53,size(p,1), []));
surface_list(end).n_outside = inf;
surface_list(end).n_inside = n_hydraulic;
surface_list(end).surface_type = 'retro';
surface_list(end).absorption = 1;
