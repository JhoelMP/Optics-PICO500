...
%% derived dimensions
vp_s = (vp_focuslen - vp_nip_top) * sin(vp_theta); % radial position of air-side center of viewport
vp_elev = (vp_focuslen - vp_nip_top) * cos(vp_theta) + vp_focuselev; % vertical position of air-side center of viewport
